...
# Dev / app ranges: 3xxx (Next/React), 5xxx (Vite 5173, Flask), 8xxx (proxies/Tomcat)
_WIDE_PORTS = "3000-3999,5000-5999,8000-8999"
...
PROFILES: list[ScanProfile] = [
    ...
    ScanProfile(
        id="wide",
        title="Wide scan",
        nmap_args=["-p", _WIDE_PORTS],
        description="3xxx + 5xxx (Vite 5173) + 8xxx — slower (~3k ports).",
    ),
    ScanProfile(
        id="version",
